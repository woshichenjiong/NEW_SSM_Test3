			...
			<form action="${pageContext.request.contextPath}/role/addRole.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">充值额度</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="rmoney"
								   placeholder="充值额度" value="" >
						</div>
						<div class="col-md-2 title">角色性别</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="rsex"
								   placeholder="角色性别" value="" >
						</div>
					</div>
				</div>
				<!--订单信息/--> <!--工具栏-->
