            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="text-center">角色性别</th>
                            </tr>
                            </thead>
                            <tbody>
                            <%--<c:forEach var="role" items="${roleById.list}">--%>
                                <tr>
                                    <td><input name="ids" type="checkbox"></td>
                                    <td>${roleById.rid}</td>
                                    <td>${roleById.rname}</td>
                                    <td>${roleById.rdesc}</td>
                                    <td>${roleById.rmoney}RMB</td>
                                    <td>${roleById.rsex}</td>
                                </tr>
                            <%--</c:forEach>--%>
                            </tbody>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/role/findAllRole.do" aria-label="Previous">返回</a></li>
                        </ul>
                    </div>
